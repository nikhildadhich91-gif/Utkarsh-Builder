              ...
              return (
                <div key={idx} className="flex flex-col items-center lg:items-start text-center lg:text-left group">
                  ...
                  <motion.div 
                    ...
                    className="h-20 w-20 rounded-full bg-white border border-[#1B1B1B]/10 flex items-center justify-center text-[#C92C15] mb-6 shadow-md transition-all duration-300 group-hover:bg-[#C92C15] group-hover:text-white group-hover:border-[#C92C15] relative z-10"
                  >
                  ...
                  {/* Description */}
                  <p className="text-sm text-[#6F6F6F] font-light leading-relaxed px-4 lg:px-0 lg:min-h-[96px]">
                    {step.description}
                  </p>
                </div>
              );
