...
const ProcessSwipeMobile = ({ steps }: { steps: ProcessStep[] }) => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div 
        ref={scrollRef}
        className="flex overflow-x-auto snap-x snap-proximity gap-4 scrollbar-none pb-4 px-2 -mx-6 md:-mx-12 text-left"
      ...
      <div className="flex justify-center gap-6 mt-2">
        <button
          onClick={() => scroll('left')}
          className="w-11 h-11 rounded-full border border-black/10 bg-white/50 backdrop-blur-md text-[#C92C15] flex items-center justify-center shadow-md active:scale-95 transition-all cursor-pointer"
