    ...
    <footer className="relative w-full overflow-hidden border-t border-black/10 bg-white/40 backdrop-blur-md text-black">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
          ...
          <motion.div variants={fadeSlideUp} className="col-span-1 md:col-span-5 text-left flex flex-col">
            <Link to="/" className="inline-block hover:scale-105 transition-all duration-300 self-start">
              <img
                src={LogoImg}
                alt="Utkarsh Builder Logo"
                className="h-[80px] md:h-[105px] lg:h-[120px] w-auto object-contain transition-all duration-300"
              />
            </Link>
            <p className="font-medium text-sm leading-[1.8] max-w-md text-black/80 mt-1 md:mt-2 mb-6">
          ...
          <motion.div variants={fadeSlideUp} className="col-span-1 md:col-span-3 text-left pt-0 md:pt-[105px] lg:pt-[120px]">
          ...
          <motion.div variants={fadeSlideUp} className="col-span-1 md:col-span-4 text-left pt-0 md:pt-[105px] lg:pt-[120px]">
            <h4 className="text-xs font-bold uppercase tracking-[0.2em] mb-6 md:mb-8 flex items-center gap-2 text-black">
              <span className="h-1.5 w-1.5 rounded-full bg-[#C92C15]" />
              Our Services
            </h4>
