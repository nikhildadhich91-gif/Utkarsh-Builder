...
export const Contact: React.FC<ContactProps> = ({ isEmbedded = false }) => {
  const [formData, setFormData] = useState({
    ...
    address: '',
    message: '',
    website_source: '', // Honeypot field (hidden from humans, filled by bots)
  });
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div className="relative">
          ...
          >
            ...
            <option value="Home Design & Construction" className="bg-white text-[#111111]">Home Design &amp; Construction</option>
            <option value="Commercial Construction" className="bg-white text-[#111111]">Commercial Construction</option>
            <option value="Interior Design & Construction" className="bg-white text-[#111111]">Interior Design &amp; Construction</option>
            <option value="Construction & Management" className="bg-white text-[#111111]">Construction &amp; Management</option>
            <option value="Renovation & Remodeling" className="bg-white text-[#111111]">Renovation &amp; Remodeling</option>
          </select>
