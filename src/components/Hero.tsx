...
export const Hero = () => {
  ...
  // Play active video, pause inactive video to save bandwidth
  useEffect(() => {
    if (mode === 'before') {
          ...
          <div className="relative z-10 w-full flex flex-col justify-center">
            ...
            <FadeIn delay={800} duration={1000}>
              <p className="text-base md:text-lg text-gray-800 mb-6 max-w-2xl font-semibold leading-relaxed">
                Say goodbye to project delays and budget overruns. Utkarsh Builder offers <PointerHighlight delay={1.8} containerClassName="text-[#C92C15] font-semibold">complete turnkey construction</PointerHighlight> from planning and design to execution and handover, ensuring quality, transparency and timely delivery.
              </p>
            </FadeIn>
