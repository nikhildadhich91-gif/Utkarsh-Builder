...
export const About: React.FC = () => {
  ...
  const imageUrl = assets.projects.paliwalCol1_2;
            ...
            <div className="lg:col-span-7 flex flex-col justify-center text-left">
              ...
              <FadeUp delay={0.4} className="mb-8">
                <p className="text-lg md:text-xl text-[#333333] leading-relaxed font-medium">
                  Welcome to Utkarsh Builder, where we turn your dream spaces into reality. With over 30+ years of experience in Rajasthan, we build premium homes and commercial buildings with outstanding quality, honest pricing and on time completion.
                </p>
              </FadeUp>
