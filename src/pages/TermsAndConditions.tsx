...
const keyTerms = [
  ...
  },
  {
    ...
    title: "Payment Terms",
    desc: "Progressive payments as per the mutually agreed schedule. Minimum balance of ₹2,00,000/- must be maintained.",
  },
  {
...
export const TermsAndConditions: React.FC = () => {
  useEffect(() => {
    document.title = "Terms & Conditions | Utkarsh Builder";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Read the Terms & Conditions of Utkarsh Builder. Learn about our service guidelines, payment milestones, defect liability and project policies.');
    }
  }, []);
        ...
        <FadeUp delay={0.1} y={20}>
          <div className="bg-white p-8 md:p-14 rounded-[28px] md:rounded-[40px] border border-black/[0.04] shadow-sm space-y-10 text-left">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-[#6F6F6F] leading-relaxed font-light">
                The Owner agrees to pay for the construction services as per the mutually agreed terms and payment schedule. A minimum balance of ₹2,00,000/- must be maintained. The Builder will commence construction within 15 days of receiving the first instalment and will complete the project within ten months from that date.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-5 text-sm text-[#6F6F6F] space-y-2 font-light leading-relaxed">
                <li>Management fees will be determined based on the project's scope and deliverables, with applicable taxes.</li>
